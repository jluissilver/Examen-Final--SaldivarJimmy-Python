def promedio(alumno):
    ...
    print('El alumno que tiene la mayor nota es {} con : '.format(promedio[maximo2]['Nombre']))
    print(promedio[maximo2]['promedio'])
    print('El alumno que tiene la menor nota es {} con : '.format(promedio[minimo2]['Nombre']))
