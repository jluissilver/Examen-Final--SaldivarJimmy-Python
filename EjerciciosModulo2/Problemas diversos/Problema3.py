def promedio(alumno):
    ...
    for i in range(len(alumno)):
        promediofinal = promediofinal + promedio[i]['promedio']
    promediofinal2 = promediofinal/len(alumno)
    print("El promedio de nota del curso total sera : ")
    return promediofinal2
